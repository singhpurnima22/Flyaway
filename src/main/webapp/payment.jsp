...
<tr>
<td>Airline Name: <%=br.getFlight().getAirline().getAirlinename()%> </td>
</tr>
<tr>
<td>Customer Name: <%=br.getCustomer().getPersoname()%> </td>
</tr>
<tr>
<td>Total Fare: <%=br.getTotalFare()%> </td>
</tr>
<tr>
<td>Number of Pasengers: <%=br.getPassengers()%> </td>
</tr>
<tr>
<td>Card Number:</td>
<td><input type="text" name="txtcard"></td></tr>
<tr>
<tr>
<td>CVV:</td>
<td><input type="text" name="txtcvv"></td></tr>
<tr>
<tr>
